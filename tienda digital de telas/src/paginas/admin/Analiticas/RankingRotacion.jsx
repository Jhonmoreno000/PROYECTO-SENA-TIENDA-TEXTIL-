/**
 * RankingRotacion.jsx — BI: Rotación de Inventario (Elite Luxury UI)
 * Hereda el ADN visual del Portada: patrón cruces + glassmorphism + rounded-[2rem]
 */
...
import { identifyDeadStock, identifyBestsellers } from '../../../utilidades/analyticsUtils';
...
function RankingRotacion() {
    const { orders } = useMetricas();
...
export default RankingRotacion;
