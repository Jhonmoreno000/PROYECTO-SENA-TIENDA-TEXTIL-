...
import { prepareColombiaHeatMapData } from '../../../utilidades/analyticsUtils';
                ...
                <div className="relative z-10">
                    ...
                    <div className={`chart-panel ${glassCard} p-6 mb-8`}>
                        ...
                        <ResponsiveContainer width="100%" height={500}>
                            <Treemap datos={heatMapData} dataKey="value" aspectRatio={4 / 3} stroke="#fff" fill="#6366f1" content={<CustomizedContent />}>
