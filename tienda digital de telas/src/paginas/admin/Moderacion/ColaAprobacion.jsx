...
function ColaAprobacion() {
    const { pendingProducts, approveProduct, rejectProduct } = useMetricas();
    ...
    const getSellerName = (p) => p?.sellerName || p?.vendedorNombre || p?.vendedor || 'Vendedor';
