...
import { EASES, microPress, microRelease } from '../utilidades/animations';
...
function IniciarSesion() {
    ...
    const setDemoCredentials = (role) => {
        const creds = {
            ...
            vendedor: { email: 'vendedor@ddtextil.com', password: 'vendedor123' },
            cliente: { email: 'cliente@ddtextil.com', password: 'cliente123' }
        };
        if (creds[role]) {
                ...
                <div className="flex w-full">
                    ...
                    >
                        ...
                        <div 
                            ...
                            style={{ backgroundImage: `url("datos:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.85' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)'/%3E%3C/svg%3E")` }}
                        ></div>
                    ...
                    {/* ===== PANEL DERECHO (Formulario de IniciarSesion) ===== */}
                            ...
                            <div className="bg-white/70 dark:bg-slate-900/80 backdrop-blur-2xl border border-white/50 dark:border-slate-600/50 p-8 sm:p-10 rounded-3xl shadow-2xl dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),_0_20px_40px_rgba(0,0,0,0.5)]">
                                ...
                                <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800/60">
                                    ...
                                    <div className="flex justify-center gap-2">
                                        ...
                                        <button onClick={() => setDemoCredentials('vendedor')} type="button" className="text-xs py-1.5 px-3 rounded-lg border border-transparent dark:border-slate-700 bg-slate-100 dark:bg-transparent text-slate-600 dark:text-slate-400 font-bold transition-all duration-300 hover:border-primary-500 hover:text-primary-500 hover:shadow-[0_0_12px_rgba(249,115,22,0.2)] dark:hover:bg-slate-800/50">Vendedor</button>
                                        <button onClick={() => setDemoCredentials('cliente')} type="button" className="text-xs py-1.5 px-3 rounded-lg border border-transparent dark:border-slate-700 bg-slate-100 dark:bg-transparent text-slate-600 dark:text-slate-400 font-bold transition-all duration-300 hover:border-primary-500 hover:text-primary-500 hover:shadow-[0_0_12px_rgba(249,115,22,0.2)] dark:hover:bg-slate-800/50">Cliente</button>
                                    </div>
                                </div>
