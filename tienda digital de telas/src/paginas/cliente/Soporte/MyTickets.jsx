/**
 * MyTickets.jsx — Listado de Tickets (Client Soporte)
 *
...
function MyTickets() {
    const { supportTickets = [] } = useMetricas();
    ...
    return (
        <LayoutPanel title="Mis Tickets de Soporte" links={enlacesCliente}>
            <PaginaAnimada>
                                            ...
                                            {(ticket.responses?.length || 0) > 0 && (
                                                <div className="p-6 md:p-8 space-y-6 bg-white dark:bg-slate-900">
                                                    ...
                                                    {ticket.responses.map(response => {
                                                        const isClient = response.from === 'cliente';
                                                        return (
                                                            <div
                                                                key={response.id}
