/**
 * LayoutPanel.jsx — Layout principal de los dashboards (Admin, Vendedor, Cliente)
 *
 ...
 * - Inicio          → enlace a la tienda (reemplaza MdHome)
...
import {
    Home as Inicio, LogOut, Menu, ChevronRight, Search, Pin, MoreVertical, Check,
} from 'lucide-react';
...
/* ──────────────────────────────────────────────
   ...
   ────────────────────────────────────────────── */
/**
 * LayoutPanel — Layout principal para los paneles de administración
 ...
 */
function LayoutPanel({ children, title, links, subtitle }) {
    const { logout, user } = useAutenticacion();
        ...
        <div ref={containerRef} className="min-h-screen bg-gray-50 dark:bg-slate-900 flex font-sans">
            ...
            >
                ...
                <div className="p-3 border-t border-gray-200/20 dark:border-slate-800/20 flex flex-col gap-2 bg-white/10 dark:bg-slate-900/10 backdrop-blur-sm">
                    ...
                    {/* Botones de acción: Home as Inicio, Rail Toggle, Logout */}
                    <div className={`flex items-center justify-between mt-1 ${isRailMode ? 'flex-col gap-2' : ''}`}>
                        ...
                        >
                            {/* Inicio: ícono de casa (reemplaza MdHome) */}
                            <Inicio className="w-6 h-6 shrink-0 group-hover:scale-110 transition-transform" />
                        </Link>
            ...
            <div className="flex-1 flex flex-col min-w-0 bg-gray-50/50 dark:bg-slate-900/50">
                ...
                <main className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto">
                    <div className="max-w-7xl mx-auto">
                        {/* Encabezado de escritorio con título */}
