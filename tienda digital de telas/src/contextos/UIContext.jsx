 ...
 * ====================================================
 * Este archivo guarda la configuración visual de la pantalla principal (Inicio):
...
export function useUI() {
    const contextos = useContext(UIContext);
    if (!contextos) {
...
export function UIProvider({ children }) {
    ...
    const value = {
        ...
        homeSections,    // Estado de visibilidad de las secciones del Inicio
